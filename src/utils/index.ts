...
export const compose =
  ...
  (...styleArgs: Array<CSSValue | Array<CSSValue>>) => {
...
export const skewX = (deg: number): string => `skewX(${deg}deg)`;

export const skewY = (deg: number): string => `skewY(${deg}deg)`;

export const skewXY = (x: number, y: number): string =>
  `${skewX(x)} ${skewY(y)}`;

export const rotateY = (a: CSSValue) => `rotateY(${a}deg)`;

export const rotate3d = (a: number, b: number, c: number, d: number): string =>
  `rotate3d(${a}, ${b}, ${c}, ${d}deg)`;

export const perspective = (a: CSSValue): string => `perspective(${a})`;

export const translateY = (a: CSSValue): string => `translateY(${a})`;

export const translateZ = (a: CSSValue): string => `translateZ(${a})`;

export const translateXY = (a: CSSValue, b: CSSValue): string =>
  `translate(${a},${b})`;

export const rotate = (a: CSSValue): string => `rotate(${a}deg)`;

export const rotateX = (a: CSSValue) => `rotateX(${a}deg)`;

export const blur = (a: CSSValue): string => `blur(${a})`;
